	...
	<ul class="flex flex-wrap gap-4 px-2 py-1">
		{#each question.choices as choice}
			<li class="p-2 rounded-lg flex">
				<span
					class="bg-teal-200 p-2 rounded-l-lg outline outline-teal-200 min-w-fit"
				>
					{choice.choice}
				</span>
				<span
					class="w-full h-full p-2 bg-white rounded-r outline outline-teal-200"
				>
					{totalVotes
