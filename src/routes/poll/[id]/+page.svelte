			...
			{#each question.choices as choice}
				<li class="flex w-full gap-4 items-center">
					...
					{#if question.hasVoted || expired}
						<span class="w-fit shrink-0 text-center"
							>{choice.votes?.length || 0}</span
						>
					{:else}
...
{:else}
	<div
		class="flex flex-col items-center justify-end gap-2 rounded p-3 min-h-[50vh]"
	>
